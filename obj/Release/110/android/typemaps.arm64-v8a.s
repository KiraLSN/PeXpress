...
map_modules:
	...
	/* module_uuid: 0bc4339d-066c-422f-88e9-597257c2312d */
	.byte	0x9d, 0x33, 0xc4, 0x0b, 0x6c, 0x06, 0x2f, 0x42, 0x88, 0xe9, 0x59, 0x72, 0x57, 0xc2, 0x31, 0x2d
	/* entry_count */
	.word	28
	/* duplicate_count */
	.word	2
	...
	/* module_uuid: d455d2b0-deb1-499a-9858-f137d52080ad */
	.byte	0xb0, 0xd2, 0x55, 0xd4, 0xb1, 0xde, 0x9a, 0x49, 0x98, 0x58, 0xf1, 0x37, 0xd5, 0x20, 0x80, 0xad
	/* entry_count */
	.word	31
	/* duplicate_count */
	.word	4
	...
	/* module_uuid: a68dbed1-5476-4c82-9916-1fe8897beedf */
	.byte	0xd1, 0xbe, 0x8d, 0xa6, 0x76, 0x54, 0x82, 0x4c, 0x99, 0x16, 0x1f, 0xe8, 0x89, 0x7b, 0xee, 0xdf
	/* entry_count */
	.word	243
	/* duplicate_count */
	.word	41
	...
	/* module_uuid: b2140ad8-ec37-4cf0-93b1-7f66c38c132a */
	.byte	0xd8, 0x0a, 0x14, 0xb2, 0x37, 0xec, 0xf0, 0x4c, 0x93, 0xb1, 0x7f, 0x66, 0xc3, 0x8c, 0x13, 0x2a
	/* entry_count */
	.word	2
	/* duplicate_count */
	.word	0
...
map_java:
	...
	.word	33554435
	/* java_name */
	.ascii	"crc642dc1cd4f88c133f3/MainActivity"
	.zero	47
	.zero	1
	...
	.word	33554436
	/* java_name */
	.ascii	"crc642dc1cd4f88c133f3/Opcoes"
	.zero	53
	.zero	1
